namespace AirlyAnalyzer.Tests.DateTimeTests
{
  ...
  public class ToLocalTime
  {
    ...
    {
      // Arrange
      var beforeTransitionTime = new DateTime(2001, 3, 25, 0, 0, 0, DateTimeKind.Utc);
      ...
      int hoursDifference = (transitionTimeLocal - beforeTransitionTimeLocal).Hours;
    ...
    {
      // Arrange
      var beforeTransitionTime = new DateTime(2001, 10, 28, 0, 0, 0, DateTimeKind.Utc);
      var transitionTime = beforeTransitionTime.AddHours(1);
    ...
    {
      // Arrange
      var beforeTransitionTimeLocal = new DateTime(2001, 3, 25, 1, 0, 0, DateTimeKind.Local);
    ...
    {
      // Arrange
      var beforeTransitionTimeLocal = new DateTime(2001, 10, 28, 2, 0, 0, DateTimeKind.Local);
      var transitionTimeLocal = beforeTransitionTimeLocal.AddHours(1);
