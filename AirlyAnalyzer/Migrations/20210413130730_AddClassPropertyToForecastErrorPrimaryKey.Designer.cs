...
namespace AirlyAnalyzer.Migrations
{
    ...
    [Migration("20210413130730_AddClassPropertyToForecastErrorPrimaryKey")]
    partial class AddClassPropertyToForecastErrorPrimaryKey
    {
            ...
            modelBuilder.Entity("AirlyAnalyzer.Models.AirQualityForecastError", b =>
                {
                    ...
                    b.HasKey("Period", "TillDateTime", "FromDateTime", "Class", "InstallationId");
